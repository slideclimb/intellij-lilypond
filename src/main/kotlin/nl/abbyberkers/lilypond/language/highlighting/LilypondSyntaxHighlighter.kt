...
class LilypondSyntaxHighlighter : SyntaxHighlighterBase() {
    ...
    override fun getTokenHighlights(tokenType: IElementType): Array<TextAttributesKey> = when (tokenType) {
        ...
        LilypondTypes.MULTI_VOICE_START, LilypondTypes.MULTI_VOICE_END -> BRACES_KEYS
        ...
        LilypondTypes.SCM_VECTOR_OPEN -> PARENTHESES_KEYS
        LilypondTypes.SCM_START, LilypondTypes.SCM_START_DOLLAR,
        LilypondTypes.SCM_LILY_START, LilypondTypes.SCM_CONTINUE -> SCHEME_MARKER_KEYS
